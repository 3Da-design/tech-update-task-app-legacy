...
|:---------|:---------|:--------|:-------|:--------|:-------|
| ベースライン | `20260826T044223Z` | 47/47 (100.0%) | 13/13 (100.0%) | 0 件 | OK |
| 更新直後 | `20260826T050627Z` | 30/47 (63.8%) | 10/13 (76.9%) | 0 件 | OK |
| 修正後 | `20260826T051427Z` | 47/47 (100.0%) | 13/13 (100.0%) | 0 件 | OK |
...
| 修正後 |  | 11 | 14 | 97 | 44 | 1 | 0 | tests 3ファイル + Postman を int 仕様へ修正（`d87c02f`）。ローカル `check-quality.sh` 一発緑（PHPUnit 47/47・Newman 13/13・PHPStan 0・ESLint OK）。**legacy 固有:** Service/Repository が無いため `normalizeListFilters` / `normalizeTaskPayload` / `listForUser` を Web/API 両 Controller に二重修正（14 files の内訳 = Controller 2・Request 3・Model/config/migration 3・Blade 2・tests 3・Postman 1） |

## フェーズ別詳細

### ベースライン (`baseline`)

- **JSON:** [`baseline.json`](experiment/metrics/runs/run-20260826T044223Z/baseline.json)
...
- **JSON:** [`after_update.json`](experiment/metrics/runs/run-20260826T044223Z/after_update.json)
- **git diff_ref:** `experiment-baseline-v1`
...
- **JSON:** [`after_fix.json`](experiment/metrics/runs/run-20260826T044223Z/after_fix.json)
- **git diff_ref:** `experiment-baseline-v1`
...
legacy	api-spec-change-status-int	baseline	20260826T044223Z	47	47	100.0	13	13	100.0	0	1				0	0	0	0	0	0			experiment/metrics/runs/run-20260826T044223Z/baseline.json	
legacy	api-spec-change-status-int	after_update	20260826T050627Z	30	47	63.83	10	13	76.92	0	1				10	75	22	10	75	22			experiment/metrics/runs/run-20260826T044223Z/after_update.json	 10 files changed, 75 insertions(+), 22 deletions(-)
legacy	api-spec-change-status-int	after_fix	20260826T051427Z	47	47	100.0	13	13	100.0	0	1				14	97	44	14	97	44			experiment/metrics/runs/run-20260826T044223Z/after_fix.json	 14 files changed, 97 insertions(+), 44 deletions(-)
```
